...
// Wrap the UI initialization in a function to avoid redeclaration issues
function initializeCameraApp() {
    ...
    function createUI() {
        ...
        // Add event listeners
        switchInput.addEventListener('change', () => toggleCamera(switchInput, knob, switchDiv, video, canvas, cameraManager));
    ...
    (async () => {
        await initDB();
        await startVideo(ui.video, ui.canvas, ui.cameraManager);
...
async function startVideo() {
    try {
        await cameraManager.initialize(video, canvas);
